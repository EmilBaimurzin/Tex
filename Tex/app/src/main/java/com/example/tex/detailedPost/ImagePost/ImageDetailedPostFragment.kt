package com.example.tex.detailedPost.ImagePost
...
import com.example.tex.Activities.ImageScreenActivity
import com.example.tex.R
import com.example.tex.databinding.ImageDetailedPostFragmentBinding
        ...
        commentAdapter?.itemClickListener = { item, position, vote, type ->
            when (type) {
                ...
                CommentClickListenerType.REPLY -> findNavController().navigate(
                    ImageDetailedPostFragmentDirections.actionImageDetailedPostFragmentToCommentReplyDialog(
                        item))
                ...
                CommentClickListenerType.PROFILE -> {
                    findNavController().navigate(ImageDetailedPostFragmentDirections.actionImageDetailedPostFragmentToSubredditProfileFragment(
                        item.nickname))
                }
            }
        }
